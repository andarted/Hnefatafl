...
class GameBoard {
    ...
    void setHighlightAt(int row, int col) {
    	squareSelection[row][col] = true;
    }
    
    void clearHighlightAt(int row, int col) {
    	squareSelection[row][col] = true;
    }
	...
	SquareType getSquareAt(int row, int col) {return squares[row][col];}
	PieceType getPieceAt(int row, int col) {return pieces[row][col];}
	int getBoardSize() {return boardSize;}
	boolean isHighlighted(int row, int col) {return squareSelection[row][col];}
	
		// - - - SETTER - - -
	
	void setBoardClear() { clearBoard(); }
	void setSquareAt(SquareType square, int row, int col){
		squares[row][col] = square;
	}
	void setPieceAt(PieceType piece, int row, int col) {
